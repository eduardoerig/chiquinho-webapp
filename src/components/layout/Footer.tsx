        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/chiquinhosorvetes/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white border border-ink-100 flex items-center justify-center text-ink-900 hover:bg-brand-red hover:text-white hover:border-brand-red transition-all duration-200">
              ...
              <a href="https://www.facebook.com/ChiquinhoSorvetesOficial/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white border border-ink-100 flex items-center justify-center text-ink-900 hover:bg-brand-red hover:text-white hover:border-brand-red transition-all duration-200">
              ...
              <a href="https://www.youtube.com/@chiquinhosorvetesoficial" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white border border-ink-100 flex items-center justify-center text-ink-900 hover:bg-brand-red hover:text-white hover:border-brand-red transition-all duration-200">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19.1c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.43z"/><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02" fill="#FFFCF9"/></svg>
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#produtos" className="text-ink-400 text-sm hover:text-brand-red transition-colors duration-150">Produtos</a></li>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              <li><a href="https://chiquinho.com.br/seja-um-franqueado/" target="_blank" rel="noreferrer" className="text-ink-400 text-sm hover:text-brand-red transition-colors duration-150">Seja um Franqueado</a></li>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:1732118200" className="text-ink-400 text-sm hover:text-brand-red transition-colors duration-150 inline-flex items-center gap-2">
              ...
              <li>
                <a href="https://chiquinho.com.br/contato/" target="_blank" rel="noreferrer" className="text-ink-400 text-sm hover:text-brand-red transition-colors duration-150 inline-flex items-center gap-2">
